...
The hypothesis that those who hold more positive feelings toward the national economy have weaker feelings towards the PRI can not be supported. However, individuals who have a negative view of the national economy, econnat=1, the coef is .3168 but it remains to be insignificant within the model as the interaction term contains 0 within the 95\% HDI interval.
...
Figure \#1 displays the posterior distribution of the effect on ideology of the PRI. As Figure \#1 demonstrates, the 95\% HDI is (0.2306, 0.3356), while the 95\% HDI for the same model, caclulated via ``Empirical Bayes'' is (0.2715, 0.3419); thus the ``Noninformative Prior'' model's HDI is wider by 0.0346 units. Figure \#2, however, displays the estimates, and HDI's, for the independent variables. All included variables, except for chuirch attendence and Socio economic status have a positive effect on ideology. However, socioeconomic status has a negative effect on an individuals ideology towards the PRI and church attendance, because the 95\% HDI contains 0, has no effect. Altogether, these two figures provide evidence in support of the hypothesis stated in question \#1: respondents, whose ideology leans more towards the right, have a more favorable of the PRI.\\
